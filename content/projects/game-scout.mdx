...
futureGoals:
  ...
  - "Integrate with Steam, Epic Games, and PlayStation Store APIs"
updates:
  - date: "2025-09-10"
...
The app is active, but there is no user at all right now. I am trying to 
get some users and feedback about it.

## What's Next

- Get User ( I have no idea how)
- Semantic Search
- Other Platforms
